...
import com.varitas.gokulpos.databinding.ActivityBarcodeBinding
    ...
    private fun manageClicks() {
        binding.apply {
            layoutToolbar.imageViewAction.clickWithDebounce {
                openActivity(Intent(this@BarcodeActivity, DashboardActivity::class.java))
            }
            ...
            if(!TextUtils.isEmpty(it)) {
                try {
                    ...
                    sweetAlertDialog.apply {
                        ...
                        confirmButtonBackgroundColor = ContextCompat.getColor(this@BarcodeActivity, R.color.base_color)
                        cancelButtonBackgroundColor = ContextCompat.getColor(this@BarcodeActivity, R.color.pink)
