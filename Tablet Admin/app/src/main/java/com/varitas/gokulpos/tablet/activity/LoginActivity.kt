...
import com.varitas.gokulpos.tablet.databinding.ActivityLoginBinding
...
@AndroidEntryPoint class LoginActivity : BaseActivity() {
    ...
    private fun askNotificationPermission() {
        try {
            ...
            val dialogFragment = AlertPopupDialog(resources.getString(R.string.lbl_PermissionRequired), true, packageName)
