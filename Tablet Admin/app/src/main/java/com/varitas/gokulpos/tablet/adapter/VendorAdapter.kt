...
import com.varitas.gokulpos.tablet.databinding.AdapterVendorBinding
import com.varitas.gokulpos.tablet.response.Vendor

class VendorAdapter(private var onClickListener: (Vendor, Int, Boolean) -> Unit) : RecyclerView.Adapter<VendorAdapter.ViewHolder>() {
