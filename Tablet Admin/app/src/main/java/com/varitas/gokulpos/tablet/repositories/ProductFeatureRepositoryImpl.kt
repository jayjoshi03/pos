...
//        })
    ...
    override suspend fun getSubCategory(parentId: Int, onSuccess: (response: BaseResponseList<CommonDropDown>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getSubCategory(parentId).enqueue(object : Callback<BaseResponseList<CommonDropDown>> {
            override fun onResponse(call: Call<BaseResponseList<CommonDropDown>>, response: Response<BaseResponseList<CommonDropDown>>) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
                    Log.e("SUBCATEGORY", list.toString())
    ...
    override suspend fun insertBrand(req : BrandDetails, onSuccess : (response : APIResponse) -> Unit, onFailure : (t : Throwable) -> Unit) {
    ...
    override suspend fun updateBrand(req : BrandDetails, onSuccess : (response : APIResponse) -> Unit, onFailure : (t : Throwable) -> Unit) {
    ...
    override suspend fun fetchTaxes(storeId: Int, onSuccess: (response: BaseResponseList<Tax>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getAllTaxes(storeId = storeId).enqueue(object : Callback<BaseResponseList<Tax>> {
            override fun onResponse(
                ...
                response.body()?.let { list ->
                    onSuccess.invoke(list)
                    Log.e("TAXES", list.toString())
                }
            }

            override fun onFailure(call: Call<BaseResponseList<Tax>>, t: Throwable) {
                onFailure.invoke(t)
                Log.e("TAXES ERROR", t.toString())
            }
        })
    }

    override suspend fun fetchTaxesFromGroup(groupId: Int, onSuccess: (response: BaseResponseList<Tax>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getTaxFromGroup(groupId = groupId).enqueue(object : Callback<BaseResponseList<Tax>> {
            override fun onResponse(
                    call: Call<BaseResponseList<Tax>>,
                    response: Response<BaseResponseList<Tax>>,
                                   ) {
    ...
    override suspend fun fetchTaxGroup(storeId: Int, typeId: Int, onSuccess: (response: BaseResponseList<CommonDropDown>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getCommonGroupDropDown(storeId = storeId, type = typeId).enqueue(object : Callback<BaseResponseList<CommonDropDown>> {
            override fun onResponse(
    ...
    override suspend fun fetchGroup(storeId: Int, onSuccess: (response: BaseResponseList<SelectedGroups>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getGroups(storeId = storeId).enqueue(object : Callback<BaseResponseList<SelectedGroups>> {
            override fun onResponse(
                    call: Call<BaseResponseList<SelectedGroups>>,
                    response: Response<BaseResponseList<SelectedGroups>>,
                                   ) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
            ...
            override fun onFailure(call: Call<BaseResponseList<SelectedGroups>>, t: Throwable) {
                onFailure.invoke(t)
    ...
    override suspend fun insertItemToGroup(req: ItemGroupRequest, onSuccess: (response: APIResponse) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.insertItemToGroup(req).enqueue(object : Callback<APIResponse> {
            override fun onResponse(call: Call<APIResponse>, response: Response<APIResponse>) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
                    Log.e("INSERT ITEM TO GROUP SUCCESS", list.toString())
                }
            }

            override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                onFailure.invoke(t)
                Log.e("INSERT ITEM TO GROUP ERROR", t.toString())
            }
        })
    }
    ...
    override suspend fun getSpecificationType(storeId: Int, typeId: Int, onSuccess: (response: BaseResponseList<CommonDropDown>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getSpecificationType(storeId = storeId, typeId = typeId).enqueue(object : Callback<BaseResponseList<CommonDropDown>> {
            override fun onResponse(call: Call<BaseResponseList<CommonDropDown>>, response: Response<BaseResponseList<CommonDropDown>>) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
    ...
    override suspend fun getItemSpecification(itemId: Int, onSuccess: (response: BaseResponseList<CommonDropDown>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getItemSpecification(itemid = itemId).enqueue(object : Callback<BaseResponseList<CommonDropDown>> {
            override fun onResponse(call: Call<BaseResponseList<CommonDropDown>>, response: Response<BaseResponseList<CommonDropDown>>) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
                    Log.e("ITEM SPECIFICATION", list.toString())
                }
            }

            override fun onFailure(call: Call<BaseResponseList<CommonDropDown>>, t: Throwable) {
                onFailure.invoke(t)
                Log.e("ITEM SPECIFICATION", t.toString())
            }
        })
    }
    ...
    override suspend fun fetchGroupDetails(groupId : Int, itemId : Int, specification : Int, price : Double, onSuccess : (response : BaseResponse<ItemGroupTax>) -> Unit, onFailure : (t : Throwable) -> Unit) {
        api.getGroupItemTax(groupId, itemId, specification, price).enqueue(object : Callback<BaseResponse<ItemGroupTax>> {
            override fun onResponse(call : Call<BaseResponse<ItemGroupTax>>, response : Response<BaseResponse<ItemGroupTax>>) {
                response.body()?.let { list->
                    onSuccess.invoke(list)
            ...
            override fun onFailure(call : Call<BaseResponse<ItemGroupTax>>, t : Throwable) {
                onFailure.invoke(t)
    ...
    override suspend fun fetchVendorDropDown(storeId: Int, onSuccess: (response: BaseResponseList<CommonDropDown>) -> Unit, onFailure: (t: Throwable) -> Unit) {
    ...
    override suspend fun insertAddSalePerson(req: AddSalePerson, onSuccess: (response: APIResponse) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.insertSalePerson(req).enqueue(object : Callback<APIResponse> {
            override fun onResponse(call: Call<APIResponse>, response: Response<APIResponse>) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
                    Log.e("INSERT SALE PERSON SUCCESS", list.toString())
                }
            }

            override fun onFailure(call: Call<APIResponse>, t: Throwable) {
                onFailure.invoke(t)
                Log.e("INSERT SALE PERSON ERROR", t.toString())
            }
        })
    }
    ...
    override suspend fun getSizeDropDown(storeId : Int, onSuccess : (response : BaseResponseList<CommonDropDown>) -> Unit, onFailure : (t : Throwable) -> Unit) {
        api.getSizeDropDown(storeId = storeId).enqueue(object : Callback<BaseResponseList<CommonDropDown>> {
            override fun onResponse(call : Call<BaseResponseList<CommonDropDown>>, response : Response<BaseResponseList<CommonDropDown>>) {
                response.body()?.let { list->
                    onSuccess.invoke(list)
                    Log.e("SIZE DROPDOWN", list.toString())
                }
            }

            override fun onFailure(call : Call<BaseResponseList<CommonDropDown>>, t : Throwable) {
                onFailure.invoke(t)
                Log.e("SIZE DROPDOWN ERROR", t.toString())
            }
        })
    }
    ...
    override suspend fun getTenderDropDown(storeId: Int, onSuccess: (response: BaseResponseList<CommonDropDown>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getTenderDropDown(storeId = storeId).enqueue(object : Callback<BaseResponseList<CommonDropDown>> {
            override fun onResponse(call : Call<BaseResponseList<CommonDropDown>>, response : Response<BaseResponseList<CommonDropDown>>) {
                response.body()?.let { list->
                    onSuccess.invoke(list)
    ...
    override suspend fun getGroupTypeList(type: Int, storeId: Int, onSuccess: (response: BaseResponseList<SelectedGroups>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getGroupTypeList(type = type, storeId = storeId).enqueue(object : Callback<BaseResponseList<SelectedGroups>> {
            override fun onResponse(
                    call: Call<BaseResponseList<SelectedGroups>>,
                    response: Response<BaseResponseList<SelectedGroups>>,
                                   ) {
    ...
    override suspend fun getGroupTypeDetails(groupId: Int, storeId: Int, onSuccess: (response: BaseResponse<GroupDetail>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getGroupTypeDetails(groupId = groupId).enqueue(object : Callback<BaseResponse<GroupDetail>> {
            override fun onResponse(
                    call: Call<BaseResponse<GroupDetail>>,
                    response: Response<BaseResponse<GroupDetail>>,
                                   ) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
                    Log.e("GROUP DETAILS", list.toString())
            ...
            override fun onFailure(call: Call<BaseResponse<GroupDetail>>, t: Throwable) {
                onFailure.invoke(t)
                Log.e("GROUP DETAILS ERROR", t.toString())
            }
        })
    ...
    override suspend fun fetchGroups(storeId: Int, typeId: Int, onSuccess: (response: BaseResponseList<ItemGroupDetail>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getItemGroup(status = Default.ACTIVE, storeId = storeId, typeId = typeId).enqueue(object : Callback<BaseResponseList<ItemGroupDetail>> {
            override fun onResponse(
                    call: Call<BaseResponseList<ItemGroupDetail>>,
                    response: Response<BaseResponseList<ItemGroupDetail>>,
                                   ) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
            ...
            override fun onFailure(call: Call<BaseResponseList<ItemGroupDetail>>, t: Throwable) {
                onFailure.invoke(t)
                Log.e("GROUP ERROR", t.toString())
            }
        })
    }

    override suspend fun fetchPromotionDropDown(storeId: Int, typeId: Int, onSuccess: (response: BaseResponseList<CommonDropDown>) -> Unit, onFailure: (t: Throwable) -> Unit) {
        api.getDiscountDropDown(storeId = storeId, typeId = typeId).enqueue(object : Callback<BaseResponseList<CommonDropDown>> {
            override fun onResponse(
                    call: Call<BaseResponseList<CommonDropDown>>,
                    response: Response<BaseResponseList<CommonDropDown>>,
                                   ) {
                response.body()?.let { list ->
                    onSuccess.invoke(list)
                    Log.e("PROMOTION DROPDOWN", list.toString())
                }
            }

            override fun onFailure(call: Call<BaseResponseList<CommonDropDown>>, t: Throwable) {
                onFailure.invoke(t)
                Log.e("PROMOTION DROPDOWN", t.toString())
            }
        })
    }
}