...
object Constants {
    ...
    @SuppressLint("SimpleDateFormat") val sdfDateFormatMMMddYY: SimpleDateFormat = SimpleDateFormat("MMM dd, yyyy")
    @SuppressLint("SimpleDateFormat") val sdfDateFormatMMddYYYY: SimpleDateFormat = SimpleDateFormat("MMddyyyy")
    const val clickDelay = 400L
    const val decimalFormatTwoPrecision: String = "0.00"
    const val dateFormat_UPC = "yyyy-MM-dd'T'HH:mm:ss"
    const val StringFormat = "%s%s"
}